...
public interface ScatterSearch {
	...
	HashMap<String, ArrayList<Double>> localSearch(HashMap<String, ArrayList<Double>> best, ArrayList<Double[]> bounds, ArrayList<Double> weights, int maxNoImprov, Double stepSize);
	ArrayList<HashMap<String, ArrayList<Double>>> constructInitialSet(ArrayList<Double[]> bounds,ArrayList<Double> weights, Integer setSize, Integer maxNoImprov, Double stepSize);
